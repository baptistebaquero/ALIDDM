...
if __name__ == '__main__':
    ...
    input_param.add_argument('--fiducial_dir', type=str, help='directory with the target data and predicted data', default='/home/luciacev-admin/Desktop/Baptiste_Baquero/Project/ALIDDM/data/prediction/test2')
